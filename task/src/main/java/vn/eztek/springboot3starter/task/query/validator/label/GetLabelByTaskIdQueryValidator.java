...
import vn.eztek.springboot3starter.task.query.validated.label.GetLabelByTaskIdQueryValidated;

@Component
@RequiredArgsConstructor
@Scope(value = "request", proxyMode = ScopedProxyMode.TARGET_CLASS)
public class GetLabelByTaskIdQueryValidator extends
        QueryValidation<GetLabelByTaskIdQuery, GetLabelByTaskIdQueryValidated> {
  private final TaskRepository taskRepository;
  private final UserRepository userRepository;
  private final UserProjectRepository userProjectRepository;

  @Override
  public GetLabelByTaskIdQueryValidated validate(GetLabelByTaskIdQuery query) {
    ...
    return GetLabelByTaskIdQueryValidated.validatedOf();
  }
}
