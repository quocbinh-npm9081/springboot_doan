...
import vn.eztek.springboot3starter.task.command.validated.label.UnAssignLabelInTaskCommandValidated;
...
public class UnAssignLabelInTaskCommandValidator extends CommandValidation<UnAssignLabelInTaskCommand, UnAssignLabelInTaskCommandValidated> {
  ...
  @Override
  public UnAssignLabelInTaskCommandValidated validate(UnAssignLabelInTaskCommand command) {
    ...
    return UnAssignLabelInTaskCommandValidated.validatedOf(loggedInUser, labels);
