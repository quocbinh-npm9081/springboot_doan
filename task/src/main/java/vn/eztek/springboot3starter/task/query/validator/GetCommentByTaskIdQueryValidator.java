...
import vn.eztek.springboot3starter.task.query.validated.GetCommentByTaskIdQueryValidated;

@Component
@RequiredArgsConstructor
@Scope(value = "request", proxyMode = ScopedProxyMode.TARGET_CLASS)
public class GetCommentByTaskIdQueryValidator extends
    QueryValidation<GetCommentByTaskIdQuery, GetCommentByTaskIdQueryValidated> {
  ...
  @Override
  public GetCommentByTaskIdQueryValidated validate(GetCommentByTaskIdQuery query) {
    ...
    return GetCommentByTaskIdQueryValidated.validatedOf();
  }
