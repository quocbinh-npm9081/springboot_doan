...
import vn.eztek.springboot3starter.task.command.validated.label.RemoveColorLabelCommandValidated;


@Component
@RequiredArgsConstructor
@Scope(value = "request", proxyMode = ScopedProxyMode.TARGET_CLASS)
public class RemoveColorLabelCommandValidator extends
        CommandValidation<RemoveLabelColorCommand, RemoveColorLabelCommandValidated> {
  ...
  @Override
  public RemoveColorLabelCommandValidated validate(RemoveLabelColorCommand command) {
    ...
    return RemoveColorLabelCommandValidated.validatedOf(loggedInUser, label);
  }
}
