package vn.eztek.springboot3starter.task.query.validator.checklist;
...
import vn.eztek.springboot3starter.task.query.validated.checklist.GetCheckListByTaskIdQueryValidated;

@Component
@RequiredArgsConstructor
@Scope(value = "request", proxyMode = ScopedProxyMode.TARGET_CLASS)
public class GetCheckListByTaskIdQueryValidator extends
    QueryValidation<GetCheckListByTaskIdQuery, GetCheckListByTaskIdQueryValidated> {
  ...
  @Override
  public  GetCheckListByTaskIdQueryValidated validate( GetCheckListByTaskIdQuery query) {
    ...
    return  GetCheckListByTaskIdQueryValidated.validatedOf();
  }
