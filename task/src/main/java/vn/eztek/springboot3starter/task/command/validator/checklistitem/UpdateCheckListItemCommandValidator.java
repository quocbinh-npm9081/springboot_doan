...
import vn.eztek.springboot3starter.task.command.validated.checklistitem.UpdateCheckListItemCommandValidated;

@Component
@RequiredArgsConstructor
@Scope(value = "request", proxyMode = ScopedProxyMode.TARGET_CLASS)
public class UpdateCheckListItemCommandValidator extends
    CommandValidation<UpdateCheckListItemCommand, UpdateCheckListItemCommandValidated> {
  ...
  @Override
  public UpdateCheckListItemCommandValidated validate(UpdateCheckListItemCommand command) {
    ...
    return UpdateCheckListItemCommandValidated.validatedOf(loggedInUser, checkListItem);
  }
