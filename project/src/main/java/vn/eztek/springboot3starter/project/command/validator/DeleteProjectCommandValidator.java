...
import vn.eztek.springboot3starter.project.command.validated.DeleteProjectCommandValidated;
...
public class DeleteProjectCommandValidator extends
    CommandValidation<DeleteProjectCommand, DeleteProjectCommandValidated> {

  private final ProjectRepository projectRepository;
  private final UserRepository userRepository;

  @Override
  public DeleteProjectCommandValidated validate(DeleteProjectCommand command) {
    ...
    return DeleteProjectCommandValidated.validatedOf(project, existUser);
  }
