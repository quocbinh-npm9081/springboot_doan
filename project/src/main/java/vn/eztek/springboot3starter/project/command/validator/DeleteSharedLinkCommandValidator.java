...
import vn.eztek.springboot3starter.project.command.validated.DeleteSharedLinkCommandValidated;
...
public class DeleteSharedLinkCommandValidator extends
    CommandValidation<DeleteSharedLinkCommand, DeleteSharedLinkCommandValidated> {
  ...
  @Override
  public DeleteSharedLinkCommandValidated validate(DeleteSharedLinkCommand command) {
    ...
    if (!isJoinedMember) {
      throw new AccessDeniedException("you-can-not-delete-shared-link-in-this-project");
    }
    ...
    return DeleteSharedLinkCommandValidated.validatedOf(existUser, invitation);
  }
