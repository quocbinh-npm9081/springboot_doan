...
import vn.eztek.springboot3starter.project.query.validated.ListProjectMembersQueryValidated;
...
public class ListProjectMembersQueryValidator extends
    QueryValidation<ListProjectMembersQuery, ListProjectMembersQueryValidated> {
  ...
  @Override
  public ListProjectMembersQueryValidated validate(ListProjectMembersQuery query) {
    ...
    if (!isJoinedMember) {
      throw new AccessDeniedException("you-are-not-permission-to-view-member-of-this-project");
    }

    return ListProjectMembersQueryValidated.validatedOf(members);
  }
