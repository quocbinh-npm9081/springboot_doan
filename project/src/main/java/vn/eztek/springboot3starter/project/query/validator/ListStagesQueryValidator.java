...
import vn.eztek.springboot3starter.project.query.validated.ListStagesQueryValidated;
...
public class ListStagesQueryValidator extends
    QueryValidation<ListStagesQuery, ListStagesQueryValidated> {
  ...
  @Override
  public ListStagesQueryValidated validate(ListStagesQuery query) {
    ...
    return ListStagesQueryValidated.validatedOf(project);
  }
